...
class Adopt_request extends CI_Controller {
    ...
    public function add() {
        ...
        if ($this->db->insert('queue', $data)) {
            ...
            echo 'Thank you, ' . $name . '. Please check your email to confirm your adoption of this plant.';
        }
    }
    ...
    public function confirm($code) {
        ...
        if ($query->num_rows() > 0) {
            ...
            echo 'Thank you, ' . $result->name . '!<br />You have successfully adopted this plant.';
        }
    }
